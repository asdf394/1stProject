	...
	private void initialize(int num, MemberDTO memDTO) {
		...
		bnt_complete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				noticeBoardGUI mainGui = new noticeBoardGUI(memDTO); // 메인 창 띄우기 객체 생성
			}
		...
		btn_delete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				frame.dispose(); // 창 닫기
				noticeBoardGUI borad = new noticeBoardGUI(memDTO); // 메인 창 띄우기 객체 생성
		...
		String a = this.getClass().getResource("../img/eraser.png").getPath();
