...
public class MemberInfoOnlyGUI {
	...
	private void initialize(MemberDTO memDTO) {
		...
		memberList1 = dao.memRentToy(memDTO.getId());
		...
		JLabel lbl_Info = new JLabel("\uC5F0\uB77D\uCC98");
		...
		JLabel lblNewLabel_2 = new JLabel(memDTO.getId());
		lblNewLabel_2.setBounds(126, 26, 150, 15);
		panel.add(lblNewLabel_2);

		JLabel label_5 = new JLabel(memDTO.getName());
		label_5.setBounds(126, 79, 150, 15);
		panel.add(label_5);

		JLabel label_6 = new JLabel(memDTO.getAddress());
		label_6.setBounds(126, 131, 150, 15);
		panel.add(label_6);

		String sale = "";
		if (memDTO.getSaletarget() == 2) {
			sale = "50% 할인대상자";
		}

		JLabel label_7 = new JLabel(sale);
		label_7.setBounds(126, 191, 150, 15);
		panel.add(label_7);

		JLabel label_8 = new JLabel("010" + memDTO.getPhoneNumber());
		label_8.setBounds(126, 235, 187, 34);
		panel.add(label_8);
	}
}